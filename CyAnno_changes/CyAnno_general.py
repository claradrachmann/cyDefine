...
dir=args.dir #'data/Levine13/CyAnno_data
...
######### Optional #######
threads = -1 			## (Int) number of available threads to use; -1 if all available threads are to be used
...
Findungated = not unassigned		## Logical; if True then 'ungated' cells will be predicted. However, orignal sample ID (live cells) must be present in LiveFileinfo. 'ungated' cells are defined as all the cells that not the part of any of 'gated' cell population.
